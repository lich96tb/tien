...
public class main_question extends AppCompatActivity {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (a == 0) {
                    ...
                    dialog.setMessage(R.string.bandahoanthanhbaithi);
                    dialog.setPositiveButton(R.string.dongy, new DialogInterface.OnClickListener() {
                        @Override
                    ...
                    dialog.setNegativeButton(R.string.huybo, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.cancel();
                        }
    ...
    public void Hien(int d) {
        ...
        dialog.setNegativeButton(R.string.thoat, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                finish();
            }
